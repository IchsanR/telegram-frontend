								...
								<section className={`container-fluid row`}>
									<div className={`col-md-12 row py-md-4`}>
										...
										<div className="col-md-1">
											<img
												src={`${activeReceiver.profile_pic}`}
												alt=""
			...
			<div className={`${style.mobile}`}>
				<main className="container-fluid row">
					{mobile === 1 ? (
						...
						<section
							className={`col-md-8 ${style.rightPanel}`}
							style={{ height: `${height}px` }}>
							{activeChat === 1 ? null : (
								<>
									<section className={`container-fluid row`}>
										<div className={`col-md-12 d-flex flex-row py-md-4`}>
											<div className={`my-auto me-2 me-md-0 ${style1.pp}`}>
												<img
													src={back}
													alt=""
													className={`${style1.backButtons}`}
													onClick={(e) => onMobile(e)}
												/>
											</div>
											<div className="col-md-1 me-2 me-md-0">
												<img
													src={`${activeReceiver.profile_pic}`}
													alt=""
													className={`${style1.profileImageHeaders}`}
									...
									<section className={`container-fluid row ${style.chatArea}`}>
										<form
											className="d-flex col-md-12 py-3 px-md-4"
											onSubmit={onSubmitMessage}>
											<input
